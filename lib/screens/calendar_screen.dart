...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  List<TaskModel> _getEventsForDay(DateTime day) {
    // Convertimos la fecha a un formato que podamos usar como clave
    final normalizedDay = DateTime(day.year, day.month, day.day);
    
    // Devolvemos los eventos para ese día, o una lista vacía si no hay
  ...
  Color _getMarkerColor(List<TaskModel> dayTasks) {
    if (dayTasks.isEmpty) return Colors.blue;
      ...
      body: StreamBuilder<List<TaskModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            // No hay tareas, mostramos el calendario vacío
            _events = {};
            _monthlyTaskCount = 0;
          } else {
            // Procesamos las tareas para el calendario
            _processTasksForCalendar(snapshot.data!);
          }
                    ...
                    return Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: _getMarkerColor(events as List<TaskModel>),
                        ),
                      ),
                    );
                  },
